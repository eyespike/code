...
#define MagickReleaseDate  "2016-11-26"
#define MagickChangeDate   "20141025"
#define MagickFeatures "DPC OpenMP Modules"
#define MagickDelegates "bzlib djvu mpeg fftw fontconfig freetype jbig jng jpeg lcms lqr lzma openexr pango png ps rsvg tiff wmf x xml zlib"
